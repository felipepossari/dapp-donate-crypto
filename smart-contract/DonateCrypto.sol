...
contract DonateCrypto {
    ...
    function donate(uint256 id) public payable {
        require(msg.value > 0, "You must send a donation greater than 0");
        require(campaigns[id].active == true, "Campaign not active");
    ...
    function withdraw(uint256 id) public {
        ...
        require(campaign.active == true, "Campaign not active");
